...
exports.loadSocialProfiles = exports.loadNewGroupMessages = exports.loadGroupsIdList = exports.loadGroupMessages = exports.loadGroupInfo = exports.chatmeContractAddress = void 0;
...
var loadGroupInfo = function loadGroupInfo(wallet, chatId) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return wallet.chatmeContract.getGroupById(parseInt(chatId));
            case 2:
              group = _context.sent;
              resolve(group);
            case 4:
...
exports.loadGroupInfo = loadGroupInfo;
var loadGroupsIdList = function loadGroupsIdList(wallet) {
  return new Promise( /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return wallet.chatmeContract.getUserGroups(wallet.accountId);
            case 3:
...
exports.loadGroupsIdList = loadGroupsIdList;
var chatmeContractAddress = function chatmeContractAddress(network) {
  return "chatme.near";
};
exports.chatmeContractAddress = chatmeContractAddress;
var getTheGraphApiUrl = function getTheGraphApiUrl(network) {
  var contract = "chatme-main";
  switch (network) {
    case "local":
...
exports.loadGroupMessages = loadGroupMessages;
...
exports.loadNewGroupMessages = loadNewGroupMessages;
var loadSocialProfiles = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(wallet, addressList) {
    var userList, result, profiles;
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            addressList.map(function (address) {
              userList.push("".concat(address, "/profile/**"));
            });
            _context5.next = 5;
            return wallet.socialContract.get(userList);
          case 5:
            ...
            addressList.map(function (address) {
              result[address] = (0, _transform.transformProfile)(address, profiles[address] || {});
            });
  ...
  return function loadSocialProfiles(_x5, _x6) {
    return _ref5.apply(this, arguments);
  };
}();
exports.loadSocialProfiles = loadSocialProfiles;